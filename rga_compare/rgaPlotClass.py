...
class RGAPlot(pg.PlotWidget):
    def __init__(self):
        ...
        # Inside RGAPlot.__init__
        self.setClipToView(True)     # DO NOT draw points that are off-screen
        self.setDownsampling(mode='peak', auto=True, ds=1) # Reduce points when zoomed out
